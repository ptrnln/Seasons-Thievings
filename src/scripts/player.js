...
class Player extends Entity {
    constructor(game, canvas, id, pos) {
        ...
        let animationName = this.animations[this.currentAction()].name;
        let repeats = this.animations[this.currentAction()].repeats;
        ...
        this.hitBoxImg.src = this.currentAnimation.currentFrame().src;
    ...
    updateAnimation(animationName) {
        this.currentAnimation.cease();
        const newAnimation = this.animations[this.currentAction()]
        this.currentAnimation = new SpriteAnimation({
            name: animationName,
            repeats: newAnimation.repeats
        })
    }
